...
describe("Ui Addition - Component", () => {
  ...
  it("should porcentaje operator1 and operator2 when i click the porcentaje button ", () => {
    ...
    component.operator1 = 50;
    component.operator2 = 16;
    let porcentajeButton = fixture.debugElement.query(
  ...
  it("should radianes operator1 when i click the radianes button ", () => {
    // Arrange
    component.operator1 = 180;
    let radianesButton = fixture.debugElement.query(By.css(".radianes-button"));

    // Act
    radianesButton.triggerEventHandler("click", null);

    // Assert
    expect(component.result).toBe(3.141592653589793);
  });
